...
export const configuredApiBase = normalizeApiBase(import.meta.env.VITE_API_BASE || '');
export const configuredManagementKey = (import.meta.env.VITE_MANAGEMENT_KEY || '').trim();
