...
const MODEL_CATEGORIES = [
  {
    id: 'gpt',
    label: 'GPT',
    patterns: [/gpt/i, /\bo\d\b/i, /\bo\d+\.?/i, /\bchatgpt/i, /codex-auto-review/i]
  },
  ...
  { id: 'mimo', label: 'MiMo', patterns: [/\bmimo(?:[-_.]|\b)/i] },
  { id: 'hunyuan', label: 'Hunyuan', patterns: [/\bhy3(?:[-_.]|\b)/i, /hunyuan/i] },
];
