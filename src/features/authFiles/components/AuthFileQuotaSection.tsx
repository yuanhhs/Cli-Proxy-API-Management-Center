...
const getQuotaConfig = (type: QuotaProviderType) => {
  ...
  if (type === 'opencode') return OPENCODE_CONFIG;
...
export function AuthFileQuotaSection(props: AuthFileQuotaSectionProps) {
  ...
  const quota = useQuotaStore((state) => {
    ...
    if (quotaType === 'opencode') return state.openCodeQuota[file.name] as QuotaState;
    if (quotaType === 'xai') return state.xaiQuota[file.name] as QuotaState;
    return state.openCodeQuota[file.name] as QuotaState;
  });
  ...
  const updateQuotaState = useQuotaStore((state) => {
    ...
    if (quotaType === 'opencode')
      return state.setOpenCodeQuota as unknown as (updater: unknown) => void;
