...
export interface AntigravityQuotaSummaryModelPayload {
  displayName?: string;
  display_name?: string;
  description?: string;
  quotaInfo?: AntigravityQuotaSummaryBucketPayload | null;
  quota_info?: AntigravityQuotaSummaryBucketPayload | null;
  remainingFraction?: number | string;
  remaining_fraction?: number | string;
  resetTime?: string;
  reset_time?: string;
...
export interface AntigravityQuotaSummaryPayload {
  ...
  models?:
    | Record<string, AntigravityQuotaSummaryModelPayload>
...
export interface CodexUsageWindow {
  ...
  window_usage_tokens?: number | string;
  windowUsageTokens?: number | string;
}
